...
export const Projects = () => {
  ...
  const issueTrackingToolImage = [
    {
      id: 1,
      url: "/images/kiran-img/loginpage.png",
    },
    {
      id: 2,
      url: "/images/kiran-img/dashboardpage.png",
    },
    {
      id: 3,

      url: "/images/kiran-img/profilepage.png",
    },
    {
      id: 4,

      url: "/images/kiran-img/studentattendance.png",
    },
    {
      id: 5,

      url: "/images/kiran-img/batchattendance.png",
    },
    {
      id: 6,

      url: "/images/kiran-img/signuppage.png",
     
    },
    {
      id: 7,

      url: "/images/kiran-img/otppage.png",
    },
    {
      id: 8,

      url: "/images/kiran-img/logoutpage.png",
    },
  ];
        ...
        <div className="lg:grid-cols-4 grid xl:grid-cols-4 md:grid-cols-1 gap-11   w-full h-auto   my-4 ">
          <div className="flex flex-col col-span-2">
            ...
            <div className="xl:hidden lg:hidden md:block sm:block xs:block">
              ...
              technologies to enhance efficiency, accuracy, and compliance in attendance management.
