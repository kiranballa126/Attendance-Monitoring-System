...
export const WorkExperience = () => {
  ...
  const data = [
    {
      companyName: "Train A Tech PVT LTD",
    },
    // {
  ...
  const experienceData = [
...

    {
      ...
      companyName: "Train a Tech",
      companyWebsite: "https://trainatech.co.in/", 
      ...
      description1: [
        ...
        "  Participated in a MERN stack internship, gaining practical experience in web development technologies.",
       "  Learned HTML, CSS, and JavaScript for building the frontend of web applications, focusing on creating responsive",
